...
func (o *openAPIUtil) Configure() *openAPIUtil {
	...
	o.Info.Title = "home-care"
	o.Info.Description = "The home-care allows you to perform all the operations that you do with our applications. " +
		"home-care is built using REST principles which ensures predictable URLs, uses standard HTTP response codes, " +
