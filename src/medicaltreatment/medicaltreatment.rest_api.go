...
// RESTAPIHandler provides a convenient interface for MedicalTreatment REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the MedicalTreatment REST API handler.
...
// GetByID is the REST API handler for `GET /api/medical_treatments/{id}`.
...
// Get is the REST API handler for `GET /api/medical_treatments`.
...
// Create is the REST API handler for `POST /api/medical_treatments`.
...
// UpdateByID is the REST API handler for `PUT /api/medical_treatments/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/medical_treatments/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/medical_treatments/{id}`.
