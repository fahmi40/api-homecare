...
// RESTAPIHandler provides a convenient interface for Transaction REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Transaction REST API handler.
...
// GetByID is the REST API handler for `GET /api/transactions/{id}`.
...
// Get is the REST API handler for `GET /api/transactions`.
...
// Create is the REST API handler for `POST /api/transactions`.
...
// UpdateByID is the REST API handler for `PUT /api/transactions/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/transactions/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/transactions/{id}`.
