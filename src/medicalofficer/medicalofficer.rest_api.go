...
// RESTAPIHandler provides a convenient interface for MedicalOfficer REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the MedicalOfficer REST API handler.
...
// GetByID is the REST API handler for `GET /api/medical_officers/{id}`.
...
// Get is the REST API handler for `GET /api/medical_officers`.
...
// Create is the REST API handler for `POST /api/medical_officers`.
...
// UpdateByID is the REST API handler for `PUT /api/medical_officers/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/medical_officers/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/medical_officers/{id}`.
