...
// RESTAPIHandler provides a convenient interface for Registration REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Registration REST API handler.
...
// GetByID is the REST API handler for `GET /api/registrations/{id}`.
...
// Get is the REST API handler for `GET /api/registrations`.
...
// Create is the REST API handler for `POST /api/registrations`.
...
// UpdateByID is the REST API handler for `PUT /api/registrations/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/registrations/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/registrations/{id}`.
